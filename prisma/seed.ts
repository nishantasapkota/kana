...
const katakanaSentences = [
  { text: "サンキュー", reading: "sankyu", meaning: "Thank you (casual, from English)", missingIndices: [1, 3], blanks: ["ン", "ュ"] },
  { text: "コンニチハ", reading: "konnichiha", meaning: "Hello (written formally in katakana)", missingIndices: [2], blanks: ["ニ"] },
  { text: "アイスクリーム", reading: "aisukuriimu", meaning: "Ice cream", missingIndices: [2, 5], blanks: ["ス", "リ"] },
  ...
  { text: "パン", reading: "pan", meaning: "Bread", missingIndices: [0], blanks: ["パ"] },
  { text: "ニュース", reading: "nyuusu", meaning: "News", missingIndices: [1, 3], blanks: ["ュ", "ス"] },
  ...
  { text: "コーヒー", reading: "koohii", meaning: "Coffee", missingIndices: [1, 3], blanks: ["ー", "ー"] },
  { text: "ジュース", reading: "juusu", meaning: "Juice", missingIndices: [1, 2], blanks: ["ュ", "ー"] },
  { text: "ケーキ", reading: "keeki", meaning: "Cake", missingIndices: [1], blanks: ["ー"] },
  { text: "ピアノ", reading: "piano", meaning: "Piano", missingIndices: [0, 2], blanks: ["ピ", "ノ"] },
  { text: "ソファー", reading: "sofaa", meaning: "Sofa", missingIndices: [0, 3], blanks: ["ソ", "ー"] },
  { text: "ドア", reading: "doa", meaning: "Door", missingIndices: [0], blanks: ["ド"] },
  { text: "ノート", reading: "nooto", meaning: "Notebook", missingIndices: [1, 3], blanks: ["ー", "ト"] },
  { text: "ペン", reading: "pen", meaning: "Pen", missingIndices: [0, 1], blanks: ["ペ", "ン"] },
  { text: "ボタン", reading: "botan", meaning: "Button", missingIndices: [0, 2], blanks: ["ボ", "タ"] },
  { text: "マイク", reading: "maiku", meaning: "Microphone", missingIndices: [1, 2], blanks: ["イ", "ク"] },
];
